#include "Camera.h"
        void Camera2D::Init(Float2 Position,Float2 Scale,const Float2& viewPortSize){
        ...
        void Camera2D::RecalculateMatrix(){
            ...
            glm::mat4 proj = glm::ortho(-1.0f*aspectRatio, 1.0f*aspectRatio, -1.0f, 1.0f, 0.0f, 1.0f);
